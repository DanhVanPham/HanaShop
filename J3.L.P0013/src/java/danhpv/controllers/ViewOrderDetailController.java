...
public class ViewOrderDetailController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (orderId != null) {
                List<OrderDetail> listOrderDetails = orderDetailsDAO.getListOrderDetailByOrderId(orderId);
                if (!listOrderDetails.isEmpty()) {
                    request.setAttribute("LIST_ORDER_DETAIL", listOrderDetails);
                    url = SUCCESS;
                } else {
                    request.setAttribute("ERROR", "Get order detail failed!");
                }
            } else {
                request.setAttribute("ERROR", "Some thing is wrong. Get order detail failed!");
            }
        } catch (Exception e) {
