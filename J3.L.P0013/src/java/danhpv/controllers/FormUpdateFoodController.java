 ...
 * @author DELL
 */
public class FormUpdateFoodController extends HttpServlet {

    private static final String ERROR = "error.jsp";
    private static final String SUCCESS = "formUpdateFood.jsp";
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(checkFoodExisted != null) {
                request.setAttribute("FOOD", checkFoodExisted);
                url = SUCCESS;
            }else {
