<%-- 
    Document   : formCreateFood
    Created on : Jan 6, 2021, 11:49:27 PM
    Author     : DELL
--%>
...
<html>
    ...
    <body>
        ...
        <c:if test="${not empty sessionScope.USER}">
            ...
            <h3 style="text-align: center;font-size: 250%;text-transform: uppercase;font-weight: bold;margin-top: 3%;">Form Create New Food</h3>   
            <form action="CreateFoodController" method="POST" name="myForm" enctype="multipart/form-data" onsubmit="return validateForm();">
                <div class="row py-4">
                ...
                <div class="form-group" style="margin-left: 20%;">
                    ...
                    <input type="text" name="txtFoodName" class="form-control" id="foodName"  placeholder="Enter Food Name:" aria-describedby="emailHelp"  style="width: 70%;"/>
                    <font color="red">${requestScope.INVALID.foodNameError}</font>
                </div>
                <div class="form-group" style="margin-left: 20%;">
                    <label for="exampleInputEmail1">Food Description:</label>
                    <input type="text" name="txtFoodDescription" class="form-control" id="foodDescription" aria-describedby="emailHelp" placeholder="Enter Food Description"  required style="width: 70%;"/>
                    <font color="red">${requestScope.INVALID.foodDescriptionError}</font>
                </div>
                <div class="form-group" style="margin-left: 20%;">
                    <label for="exampleInputEmail1">Quantity: </label>
                    <input type="number" name="txtQuantity" class="form-control" id="foodQuantity" required aria-describedby="emailHelp" placeholder="Enter Food Quantity"  required style="width: 70%;" min="1"/>
                    <font color="red">${requestScope.INVALID.foodQuantityError}</font>
                </div>
                <div class="form-group" style="margin-left: 20%;">
                    <label for="exampleInputPrice">Price: </label>
                    <input type="number" name="txtPrice" class="form-control" id="foodPrice" required aria-describedby="emailHelp" placeholder="Enter Food Price"  required style="width: 70%;" min="0"/>
                ...
                <br/>
                <button type="submit" name="action" value="CreateNewFood" class="btn btn-primary mb-5 mt-3" style="margin-left: 45%;" onclick="return validateForm();">Create Food</button>
        ...
        <script>
            function validateForm() {
                ...
                if (imageUrl.length === 0 || imageUrl === "") {
                    ...
                    alert("Food quantity must be number greater than 0!");
                    document.getElementById("foodQuantity").focus();
                    return false;
                } else if (isNaN(foodPrice) || foodPrice <= 0 || foodPrice === null) {
                    alert("Food price must be number greater than 0!");
